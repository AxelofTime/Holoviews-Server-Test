...
def new_data(*args, **kwargs):
    ...
    ipm2 = data.fake_ipm2.read()
    ebeam = data.fake_L3.read()
    #print(ipm2)
    #print(ebeam)
    #ipm2List.append(ipm2['fake_beam_fake_ipm2']['value'])
    #ebeamList.append(ebeam['value'])
    ipm2Time = ipm2['fake_beam_fake_ipm2']['timestamp']
    ebeamTime = ebeam['fake_beam_fake_L3']['timestamp']
    print("ipm2: " + str(ipm2Time) + " ebeam: " + str(ebeamTime))
    #ipm2Time = data.fake_ipm2.read()
    # print(len(ipm2List))
